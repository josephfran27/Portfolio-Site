...
const Skills = () => {
    ...
    return (
        <section ref={sectionRef} id="skills" className="flex items-center justify-center px-4 sm:px-8 py-12 mb-30">
            <div className="max-w-7xl mx-auto w-full">
                ...
                <div className="px-2 sm:px-4 py-6 bg-zinc-900 rounded-lg border-2 border-gray-700 shadow-lg hover:scale-101 transition-transform duration-300 hover:border-gray-500">
                    ...
                    <div className="relative overflow-hidden py-8">
                        ...
                        <div className={`flex w-max ${isVisible ? 'animate-slide' : ''}`}
                            style={{ "--marquee-speed": "15s" } as React.CSSProperties}
                        >

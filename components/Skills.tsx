    ...
    return (
        <section ref={sectionRef} id="skills" className="min-h-screen flex items-center justify-center px-4 sm:px-8 py-12">
            <div className="max-w-7xl mx-auto w-full">
                ...
                <h2 className="text-2xl sm:text-3xl mb-1 text-gray-400 text-center">Languages</h2>
                {/* sliding icons */}
                        ...
                        <div className="flex gap-12 px-6">
                            ...
                            <div className="flex flex-col items-center gap-2 min-w-[80px]">
                                <img 
                                    ...
                                    className="w-16 h-16 sm:w-20 sm:h-20 object-contain"
                                />
                                <span className="text-sm sm:text-base text-white-50">React</span>
                            </div>
                            {/* Next.js */}
                            <div className="flex flex-col items-center gap-2 min-w-[80px]">
                                <img 
                                    ...
                                    className="w-16 h-16 sm:w-20 sm:h-20 object-contain"
                                />
                                <span className="text-sm sm:text-base text-white-50">Next.js</span>
                            </div>
                            {/* FastAPI */}
                            <div className="flex flex-col items-center gap-2 min-w-[80px]">
                                <img 
                                    ...
                                    className="w-16 h-16 sm:w-20 sm:h-20 object-contain"
                                />
                                <span className="text-sm sm:text-base text-white-50">FastAPI</span>
                            </div>
                            {/* tailwind */}
                            <div className="flex flex-col items-center gap-2 min-w-[80px]">
                                <img 
                                    ...
                                    className="w-16 h-16 sm:w-20 sm:h-20 object-contain"
                                />
                                <span className="text-sm sm:text-base text-white-50 text-center">Tailwind CSS</span>
                            </div>
                            {/* sql */}
                            <div className="flex flex-col items-center gap-2 min-w-[80px]">
                                <img 
                ...
                <h2 className="text-2xl sm:text-3xl mt-8 mb-8 text-gray-400 text-center">Developer Tools</h2>

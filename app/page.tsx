        ...
        <main>
          ...
          <section id="home" className="min-h-screen flex justify-center items-center px-8">
            <div className="max-w-3xl w-full">
              {/* photo */}
              <h2 className="text-3xl font-200 text-yellow-200 mb-4">
                Hello there! I'm-
              </h2> 
              <h1 className="text-8xl font-bold text-gray-900 dark:text-white mb-12">
                Joseph France
              </h1> 
              {/* school section */}
              ...
              <div className="flex gap-6 mt-8">
                ...
                <a  
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-zinc-900 text-white-50 rounded border-2 border-gray-700 shadow-lg hover:scale-101 transition-transform duration-300 hover:border-gray-500"
                >
                ...
                <div className="flex flex-col md:flex-row gap-8 items-center">
                  ...
                  <div className="flex-1 w-full md:w-auto">
                    <img 
                      ...
                      className="w-80 h-80 rounded-full mx-auto mb-4 object-cover border-2 border-gray-500 shadow-lg hover:scale-105 transition-transform duration-300 hover:border-gray-300"
                    />
                  </div>
                </div>
              </div>
